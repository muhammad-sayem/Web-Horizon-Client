...
const CouponCard = ({ coupon, refetch }) => {
    ...
    return (
        <div className="border border-gray-300 darkDamageborder-[#f97d5e] shadow-2xl px-6 py-10 rounded-tr-3xl rounded-bl-3xl">
            <h2 className="text-xl font-black mb-1 darkDamagetext-[#f97d5e]"> Code: {couponCode} </h2>
            <p className="text-md font-bold mb-1 darkDamagetext-[#f97d5e]"> Discount Amount: {discountAmount} </p>
            <p className="m2-4 text-xs darkDamagetext-white"> {couponDescription} </p>
            <p className="text-md font-bold mb-2 darkDamagetext-[#f97d5e]"> Expiry Date: {expiryDate} </p>
