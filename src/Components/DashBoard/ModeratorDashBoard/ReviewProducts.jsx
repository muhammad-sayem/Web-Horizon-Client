...
const ReviewProducts = () => {
  ...
  return (
    <div className="max-w-full w-full px-2 overflow-hidden">
      <h2 className="text-3xl md:text-5xl text-center text-[#1A2634] font-bold darkDamagetext-[#f97d5e] my-4">
        Review Products
      </h2>
          ...
          <tbody>
            {sortedProducts.map(product => (
              <tr key={product._id} className="border border-gray-300">
                <td className="px-2 py-2 text-sm md:text-md darkDamagetext-[#f97d5e]">{product.productName}</td>
