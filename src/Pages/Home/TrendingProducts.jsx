...
const TrendingProducts = () => {
    ...
    return (
        <div className="my-8">
            <h2 className="text-[#6D1212] text-3xl font-bold mb-6"> Trending Products </h2>
            ...
            <Link to='/products'>
                <button className="mt-3 bg-[#6D1212] text-[#FFF5D1] px-6 py-3 rounded-xl text-xl"> View All  </button>
            </Link>
        </div>
    );
};
