...
const ReviewCard = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            ...
            <div className='shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamageshadow-[1px_1px_8px_#87CEEB] p-6 rounded-2xl' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="2000">
                <div className='flex justify-center'>
                    <img src={reviewer1} className='w-16 h-16 rounded-full' alt="" />
                </div>
                <h2 className='text-center text-[#1A2634] text-2xl font-bold my-2 darkDamagetext-[#87CEEB]'> Lucas Williams </h2>
                ...
                <p className='text-center font-bold my-2 text-xl darkDamagefont-bold darkDamagetext-[#87CEEB]'> Rating </p>
            ...
            <div className='shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamageshadow-[1px_1px_8px_#87CEEB] p-6 rounded-2xl' data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="2000">
                <div className='flex justify-center'>
                    <img src={reviewer2} className='w-16 h-16 rounded-full' alt="" />
                </div>
                <h2 className='text-center text-[#1A2634] text-2xl font-bold my-2 darkDamagetext-[#87CEEB]'> Alexander Lee </h2>
            ...
            <div className='shadow-[4px_4px_10px_rgba(0,0,0,0.35)] darkDamageshadow-[1px_1px_8px_#87CEEB] p-6 rounded-2xl' data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="2000">
                <div className='flex justify-center'>
                    <img src={reviewer3} className='w-16 h-16 rounded-full' alt="" />
                </div>
                <h2 className='text-center text-[#1A2634] text-2xl font-bold my-2 darkDamagetext-[#87CEEB]'> Jacob Scott </h2>
